...
<div id="jnavbar">
    ...
    <p><a data-toggle="modal" data-target="#myModal" id="log_in_text" href="">Log In</a></p>
    <button type="button" class="show_btn" data-toggle="modal" data-target="#myModal" id="join_for_free">Join for Free</button>
